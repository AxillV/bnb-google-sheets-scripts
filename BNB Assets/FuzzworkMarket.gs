/**
 * Gives an aggregation for a list of itemID's.
 *
 * @param {object} (required) itemid's to search price for.
 * @param {object} regionID to search prices for. Default: 10000002(Jita)
...
//  prices.push(['TypeID','Percentile Sell Price'])
